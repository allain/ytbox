...
(0, _preact.render)((0, _preact.h)(
  ...
  (0, _preact.h)(_Page2.default, null)
), document.body);
    ...
    value: function render(_ref) {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          'header',
          null,
          (0, _preact.h)(_SearchBar2.default, { searchText: searchText, onChange: search })
        ),
        (0, _preact.h)(
          'section',
          null,
          (0, _preact.h)(_SearchResults2.default, { videos: videos })
        )
      );
    }
  }]);
...
function mapStateToProps(state) {
  ...
  var videos = state.results || [];

  return { searchText: searchText, videos: videos };
}
...
exports.default = function (searchText) {
  return fetch('/search?q=' + encodeURIComponent(searchText)).then(function (res) {
    return res.json();
  });
};
...
var wait = function wait(predicate, interval) {
  return predicate().then(function (result) {
    return result || delay(interval).then(function () {
      return wait(predicate, interval);
    });
  });
};
    ...
    value: function render(_ref) {
      ...
      return (0, _preact.h)(
        ...
        videos.map(function (v) {
          return (0, _preact.h)(_SearchResult2.default, { video: v });
        })
      );
    }
  }]);
...
function mapStateToProps(state, _ref2) {
  ...
  if (downloaded.find(function (v) {
    ...
    progress = -1;
    status = 'downloaded';
  } else if (failed.find(function (v) {
    return v.id === video.id;
  })) {
    status = 'failed';
  } else if (downloading.find(function (v) {
    return v.id === video.id;
  })) {
    var p = downloading.find(function (v) {
      return v.id === video.id;
    });
...
/** @jsx h */
var AudioDownloader = function (_Component) {
  _inherits(AudioDownloader, _Component);

  function AudioDownloader() {
    _classCallCheck(this, AudioDownloader);

    return _possibleConstructorReturn(this, (AudioDownloader.__proto__ || Object.getPrototypeOf(AudioDownloader)).apply(this, arguments));
  }

  _createClass(AudioDownloader, [{
    key: 'render',
    value: function render(_ref) {
      var video = _ref.video,
...
function mapStateToProps(_ref2, _ref3) {
  var downloading = _ref2.downloading,
      downloaded = _ref2.downloaded,
      failed = _ref2.failed;
  var video = _ref3.video;

  var status = void 0;
  if (downloading.find(function (v) {
    return v.id === video.id;
  })) {
    status = 'downloading';
  } else if (downloaded.find(function (v) {
    return v.id === video.id;
  })) {
    status = 'downloaded';
  } else if (failed.find(function (v) {
